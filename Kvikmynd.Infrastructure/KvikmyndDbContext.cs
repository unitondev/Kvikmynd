...
using Kvikmynd.Infrastructure.Helper;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>().HasData(
                new Movie()
                {
                    ...
                    Cover = Encoding.UTF8.GetBytes("data:image/jpeg;base64," + Base64Coder.EncodeImageToString(@"../Kvikmynd.Infrastructure/Covers/fightClub.jpg")),
                ...
                new Movie()
                {
                    ...
                    Cover = Encoding.UTF8.GetBytes("data:image/jpeg;base64," + Base64Coder.EncodeImageToString(@"../Kvikmynd.Infrastructure/Covers/americanPsycho.jpg")),
                ...
                new Movie()
                {
                    ...
                    Cover = Encoding.UTF8.GetBytes("data:image/jpeg;base64," + Base64Coder.EncodeImageToString(@"../Kvikmynd.Infrastructure/Covers/PulpFiction.jpg")),
                ...
                new Movie()
                {
                    ...
                    Cover = Encoding.UTF8.GetBytes("data:image/jpeg;base64," + Base64Coder.EncodeImageToString(@"../Kvikmynd.Infrastructure/Covers/memento.jpg")),
                ...
                new Movie()
                {
                    ...
                    Cover = Encoding.UTF8.GetBytes("data:image/jpeg;base64," + Base64Coder.EncodeImageToString(@"../Kvikmynd.Infrastructure/Covers/2001.jpg")),
                ...
                new Movie()
                {
                    ...
                    Cover = Encoding.UTF8.GetBytes("data:image/jpeg;base64," + Base64Coder.EncodeImageToString(@"../Kvikmynd.Infrastructure/Covers/NoCountryForOldMen.jpg")),
