  ...
  return (
    <Container maxWidth='sm'>
      ...
      <Paper className={classes.rootPaper} ref={containerRef}>
        <Grid container direction='column' spacing={2}>
          <Grid item className={classes.cardHeader}>
            <Avatar
              sx={{ m: 1 }}
              className={
                isConfirmEmailSucceeded ? classes.avatarBlockSucceeded : classes.avatarBlock
              }
            >
              {isConfirmEmailSucceeded ? <Done /> : <Email />}
            </Avatar>
        ...
        {isLoading ? (
          <Grid item>
            <Typography align='center'>Account confirmation in progress...</Typography>
          </Grid>
        ) : (
          <>
            <LeftRightSlide
              in={isConfirmEmailSucceeded}
              mountOnEnter
              unmountOnExit
              container={containerRef.current}
            >
              <Grid item>
                <Typography align='center'>Your email was successfully confirmed.</Typography>
              </Grid>
            </LeftRightSlide>
            <LeftRightSlide
              in={!isConfirmEmailSucceeded}
